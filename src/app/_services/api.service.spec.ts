...
describe('ApiService', () => {
  ...
  describe('#getUsers', () => {
    ...
    it('should return expected user values with various setups', () => {
      ...
      service
        .getUsers()
        .subscribe(users => expect(users).toEqual(dummyUserData), fail);
  ...
  describe('#getTeams', () => {
    ...
    it('should return expected team values with various setups', () => {
      ...
      service
        .getTeams()
        .subscribe(teams => expect(teams).toEqual(dummyTeamData), fail);
  ...
  describe('#getPosts', () => {
    ...
    it('should return expected team values with various setups', () => {
      ...
      service
        .getPosts()
        .subscribe(posts => expect(posts).toEqual(dummyPostData), fail);
  ...
  describe('#getUser', () => {
    ...
    it('should return expected users (called once)', () => {
      ...
      const req = httpTestingController.expectOne(
        service.apiUrl + '/users/5ca561173f69332cccc3860f'
      );
      expect(req.request.method).toBe('GET');
    ...
    it('should return expected user values with various setups', () => {
      ...
      service.getUser('5ca561173f69332cccc3860f').subscribe();
      service
        .getUser('5ca561173f69332cccc3860f')
        .subscribe(user => expect(user).toEqual(dummyUserData), fail);
  ...
  describe('#getPost', () => {
    ...
    it('should return expected post (called once)', () => {
      ...
      const req = httpTestingController.expectOne(
        service.apiUrl + '/posts/5c9af54eb226cd3e0c238190'
      );
      expect(req.request.method).toBe('GET');
    ...
    it('should return expected post values with various setups', () => {
      ...
      service.getPost('5c9af54eb226cd3e0c238190').subscribe();
      service
        .getPost('5c9af54eb226cd3e0c238190')
        .subscribe(post => expect(post).toEqual(dummyPostData), fail);
  ...
  describe('#deletePost', () => {
    ...
    it('should prepare to delete a post', () => {
      ...
      const req = httpTestingController.expectOne(
        service.apiUrl + '/posts/5cad65728ca7105cd4f9497f'
      );
    ...
    it('should not be able to delete post that does not exist', () => {
      service.deletePost('5cad65728ca7105cd4f9497f').subscribe(Post => {
        expect(Post.length).toEqual(0), fail;
      });
